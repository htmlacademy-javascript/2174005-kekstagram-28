...
const bigPictureContainer = document.querySelector('.big-picture'); // завели переменную для секции окна с большой фоткой
const bigImage = bigPictureContainer.querySelector('.big-picture__img'); // для изображения внутри контейнера .big-picture__img
